    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
          <div className="p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full mb-5 eth-card white-glassmorphism">
          ...
          <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
            ...
            <Input placeholder="Amount (ETH)" name="amount" type="number" value='' handleChange={() => {}} />
            ...
            {isLoading
              ? <Loader />
              : <button type="button" className="text-white w-full mt-2 border-[1px] p-2 border-[#3D47FC] rounded-full cursor-pointer" onClick={onSubmit}>Send Now</button>
            }
          </div>
        </div>
      </div>
